...
export class WalletPage {
  ...
  constructor(private navCtrl: RouterWrapperService, private service: ClientService, private cue: CommonUiElement) {
  ...
  addMoney() {
    this.navCtrl.push("add_money");
  }

  sendMoney() {
    this.navCtrl.push("bank_transfer");
  }

  tripInfo(ride) {
    if (ride) this.navCtrl.push("trip_info", { ride: ride });
  }
